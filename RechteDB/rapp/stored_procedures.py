...
def push_sp(name, sp, procs_schon_geladen):
    ...
    :param procs_schon_geladen: Löschen muss nur erfolgen, wenn die SP gbereits geladen ist. Das wird hiermit angezeigt.
...
def push_sp_rollen_fuer_NPU(procs_schon_geladen):
    ...
    ToDo: Umbeannte NPU erhalten eine neue Rolle - die alte könnte entfernt werden nach Chek der AFen
...
"""Hier stehen die Namen der Stored Procedures. Darüber wird auch die Zahl aktueller SPs ermittelt."""
sps = {
