# Generated by Django 2.2.4 on 2019-09-25 21:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='qryf3rechteneuvonimportduplikatfrei',
            name='userid',
            field=models.CharField(blank=True, db_column='userid', max_length=32, null=True),
        ),
        migrations.AlterField(
            model_name='qryf3rechteneuvonimportduplikatfrei',
            name='vip_kennzeichen',
            field=models.CharField(blank=True, db_column='vip', max_length=8, null=True),
        ),
        migrations.AlterField(
            model_name='qryf3rechteneuvonimportduplikatfrei',
